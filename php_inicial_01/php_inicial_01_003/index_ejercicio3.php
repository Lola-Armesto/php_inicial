...
{
 ?>
 <style>input:focus {border:solid red 1px;}</style>
 <?php
}
?>	
<div id = "form">
...
<p id="resultado">Mensaje: <button onclick="clean()">Limpiar</button></p>	 
...
function genera_tabla(data) {
  ...
  tabla.setAttribute("border", "2");
	...
	document.getElementById('resultado').innerHTML = " Datos enviados. Limpia formulario " + "<button onclick='clean()'>Limpiar</button>";
